                        ...
                        <div class="row text-center">
                            ...
                            <div align="center">
                                <form method="post" action=" {{ route('tipo_projeto.store')  }} ">
                                    ...
                                    <div id="oculto">
                                        <input type="number" name="id_tipo_projeto" value="{{ $tp_projeto['id_tipo_projeto'] or null }}" hidden>
                                    </div>

                                    <div class="col-lg-s12">
                                        <label for="tx_nome">Nome</label>
                                        <input type="text" name="nome" id="tx_nome" maxlength="30" value="{{ $tp_projeto['nome'] or null }}" required/>
                                    </div>
                                    <div class="col-lg-s12">
                                        <label for="tx_descricao">Descrição</label>
                                        <input type="text" name="desc" id="tx_descricao" maxlength="70" value="{{ $tp_projeto['desc'] or null  }}" required/>
                                    </div>
                                    <br>
